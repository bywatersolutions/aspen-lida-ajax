          ...
          <>
               <ModalBody>
                    ...
                    <FormControl mb="$2">
                         ...
                         <Input><InputField id="username" variant="filled" autoCorrect={false} autoCapitalize="none" size="xl" returnKeyType="next" enterKeyHint="next" onChangeText={(text) => setUsername(text)} onSubmitEditing={() => fieldRef.current.focus()} blurOnSubmit={false} textContentType="username"/></Input>
                    </FormControl>
                    <FormControl mb="$2">
                         <FormControlLabel>
                              <FormControlLabelText fontSize="sm" color={textColor}>{getTermFromDictionary('en', 'patron_email')}</FormControlLabelText>
                         </FormControlLabel>
                         <Input><InputField id="email" variant="filled" autoCorrect={false} autoCapitalize="none" size="xl" enterKeyHint="done" returnKeyType="done" onChangeText={(text) => setEmail(text)} textContentType="emailAddress" ref={fieldRef} onSubmitEditing={() => initiateResetPassword()} /></Input>
                    </FormControl>
               </ModalBody>
               <ModalFooter>
                    <ButtonGroup space="$2">
          ...
          <>
               <ModalBody>
                    ...
                    <FormControl>
                         ...
                         <Input><InputField id="username" variant="filled" autoCorrect={false} autoCapitalize="none" size="xl" returnKeyType="done" enterKeyHint="done" onChangeText={(text) => setUsername(text)} onSubmitEditing={() => initiateResetPassword()} textContentType="username"  /></Input>
                    </FormControl>
               </ModalBody>
               <ModalFooter>
                    <ButtonGroup space="$2">
