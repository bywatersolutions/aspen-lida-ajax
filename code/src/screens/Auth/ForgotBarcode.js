                              ...
                              {showResults && !results.success ? (
                                   ...
                                   <>
                                        ...
                                        <FormControl>
                                             ...
                                             <Input><InputField id="phoneNumber" variant="filled" size="xl" returnKeyType="done" enterKeyHint="done" onChangeText={(text) => setPhoneNumber(text)} onSubmitEditing={() => initiateForgotBarcode()} textContentType="telephoneNumber"/></Input>
                                        </FormControl>
                                   </>
                              )}
                         </ModalBody>
